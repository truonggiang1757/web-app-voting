...
export type PostWithUserInfoFragment = { __typename?: 'Post', id: string, title: string, text: string, createdAt: any, updatedAt: any, user: { __typename?: 'User', id: string, username: string } } & { ' $fragmentName'?: 'PostWithUserInfoFragment' };

export type UserInfoFragment = { __typename?: 'User', id: string, username: string, email: string, firstName: string, lastName: string, phoneNum: string, role: string } & { ' $fragmentName'?: 'UserInfoFragment' };
...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'PostMutationResponse', code: number, success: boolean, message?: string | null, post?: (
      { __typename?: 'Post' }
      & { ' $fragmentRefs'?: { 'PostWithUserInfoFragment': PostWithUserInfoFragment } }
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'UserMutationResponse', code: number, success: boolean, message?: string | null, user?: (
      { __typename?: 'User' }
      & { ' $fragmentRefs'?: { 'UserInfoFragment': UserInfoFragment } }
    ) | null, errors?: Array<(
      { __typename?: 'FieldError' }
...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', username: string, id: string, role: string } | null };
...
export type PostsQuery = { __typename?: 'Query', posts?: { __typename?: 'PaginatedPosts', totalCount: number, cursor: any, hasMore: boolean, paginatedPosts: Array<(
      { __typename?: 'Post' }
      & { ' $fragmentRefs'?: { 'PostWithUserInfoFragment': PostWithUserInfoFragment } }
    )> } | null };
